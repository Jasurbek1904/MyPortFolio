    ...
    return (
        <div className='bg-dark navbar'>
            <Navbar {...args} expand="lg" className='container'>
                <NavbarBrand href="/" className='navBrand' id='jasurbek'>Jasurbek</NavbarBrand>
                <NavbarToggler onClick={toggle} />
                <Collapse isOpen={isOpen} navbar className='collap'>
                    <Nav className="me-auto mynav" navbar>
                        <NavItem>
                        ...
                        <NavItem>
                            <NavLink href="#services">What I can Do</NavLink>
                        </NavItem>
                        <NavItem>
